  ...
  export function create(input: {
    ...
    const result = {
      ...
      async process(streamInput: LLM.StreamInput) {
        ...
        const prev = process.env.KILO_ACTIVE_AGENT
        process.env.KILO_ACTIVE_AGENT = streamInput.agent.name.toLowerCase()
        try {
          while (true) {
            try {
          ...
          if (prev === undefined) delete process.env.KILO_ACTIVE_AGENT
          else process.env.KILO_ACTIVE_AGENT = prev
        }
      },
    }
    return result
