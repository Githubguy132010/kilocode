export const dict = {
  ...
  "settings.agentBehaviour.addMcp": "Add MCP Server",
  "settings.agentBehaviour.addMcp.title": "Add MCP Server",
  "settings.agentBehaviour.addMcp.name": "Name",
  "settings.agentBehaviour.addMcp.name.placeholder": "e.g. my-server",
  "settings.agentBehaviour.addMcp.name.description": "Unique identifier for this MCP server.",
  "settings.agentBehaviour.addMcp.nameRequired": "Name is required",
  "settings.agentBehaviour.addMcp.nameInvalid":
    "Name must start with a lowercase letter and contain only lowercase letters, numbers, and hyphens",
  "settings.agentBehaviour.addMcp.nameTaken": "An MCP server with this name already exists",
  "settings.agentBehaviour.addMcp.scope": "Scope",
  "settings.agentBehaviour.addMcp.scope.description": "Where to save this MCP server configuration.",
  "settings.agentBehaviour.addMcp.scope.project": "Project",
  "settings.agentBehaviour.addMcp.scope.global": "Global",
  "settings.agentBehaviour.addMcp.type": "Transport",
  "settings.agentBehaviour.addMcp.type.description": "How to connect to the MCP server.",
  "settings.agentBehaviour.addMcp.type.local": "Local (stdio)",
  "settings.agentBehaviour.addMcp.type.remote": "Remote (SSE/HTTP)",
  "settings.agentBehaviour.addMcp.cancel": "Cancel",
  "settings.agentBehaviour.addMcp.button": "Add Server",
  ...
  "settings.agentBehaviour.editMcp.enabled": "Enabled",
  "settings.agentBehaviour.editMcp.enabled.description": "Whether this MCP server is active.",
  ...
  "settings.agentBehaviour.editMcp.timeout": "Timeout (ms)",
  "settings.agentBehaviour.editMcp.timeout.description":
    "Connection timeout in milliseconds. Leave blank to use the default.",
  "settings.agentBehaviour.editMcp.timeout.placeholder": "30000",
  "settings.agentBehaviour.editMcp.headers": "Headers",
  "settings.agentBehaviour.editMcp.headers.help": "Custom HTTP headers sent with every request.",
  "settings.agentBehaviour.editMcp.oauth": "OAuth",
  "settings.agentBehaviour.editMcp.oauth.help": "Auto-detect OAuth by default, or disable it explicitly.",
  "settings.agentBehaviour.editMcp.oauth.auto": "Auto-detect",
  "settings.agentBehaviour.editMcp.oauth.disabled": "Disabled",
  ...
  "settings.agentBehaviour.mcpEmpty": 'No MCP servers configured. Click "Add MCP Server" to get started.',
