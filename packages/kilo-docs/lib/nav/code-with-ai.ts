...
export const CodeWithAiNav: NavSection[] = [
  {
    ...
    links: [
      ...
      { href: "/code-with-ai/platforms/vscode", children: "VS Code Extension (Current)" },
      {
        href: "/code-with-ai/platforms/jetbrains",
        children: "JetBrains Extension (Legacy)",
      },
      { href: "/code-with-ai/platforms/cli", children: "CLI (Current)" },
      { href: "/code-with-ai/platforms/cloud-agent", children: "Cloud Agent" },
      { href: "/code-with-ai/platforms/mobile", children: "Mobile Apps" },
      { href: "/code-with-ai/platforms/slack", children: "Slack (Legacy)" },
